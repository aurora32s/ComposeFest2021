...
fun TodoScreen(
    ...
    Column {
        ...
        // add TodoItemInputBackground and todoItem
        // at the top of TodoScreen
...
fun TodoRow(
    ...
    // this is a float between 0.3 and 0.9
...
fun TodoItemEntryInput (onItemComplete : (TodoItem) -> Unit) {
    ...
    TodoItemInput(
        ...
        // buttonSlot is the last parameter to TodoItemInput,
...
fun TodoItemInput (
    ...
    // onItemComplete is an event will fire when an item
...
// mutableStateOf creates a MutableState<T>
// which is an observable state holder built into compose.
@Composable
